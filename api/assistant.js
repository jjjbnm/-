function localAnswer(question, profile) {
  ...
  return 'אני כאן כדי לענות על שאלות על רצף. שאל אותי ישירות על משתמש מחובר, מנוי, גיל, חוקים, סטטוס, חנות, לוחות, סקר, אירוע או קובץ.';
}
